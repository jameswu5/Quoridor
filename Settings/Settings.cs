...
public static class Settings
{
    ...
    public static class Board
    {
        ...
        public static readonly Quoridor.Board.PlayerType[] PlayerTypes = Preset.Preset1;
        public static readonly int NumOfPlayers = PlayerTypes.Length;
        public static readonly int WallsPerPlayer = 20 / NumOfPlayers;
        ...
        public static readonly int WLCircleRadius = 7;
        public const int WLCirclePadding = 7;
        public const int WLPadding = 15;
        public static readonly int WLUILength = WallsPerPlayer * (WLCircleRadius * 2 + WLCirclePadding) - WLCirclePadding;
